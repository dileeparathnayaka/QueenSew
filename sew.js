                            ...
                            if (Raviya.LANG == 'SI') {
                                if (error.message.includes('URL')) {
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ දෝෂ විශ්ලේෂණය [Sew Queen] 🧟‍♀️*' + 
                                        ...
                                        '\n*විසදුම:* _LOG අංකය හැර ඕනෑම චැට් එකකදී ඔබට විධානයන් භාවිතා කළ හැකිය group=.https://chat.whatsapp.com/GS7ZfzGCajz8Jylj2NqsZH_'
                                        , MessageType.text
                                    );
                                }
                                    ...
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ දෝෂ විශ්ලේෂණය [Sew Queen] 🧟‍♀️*' + 
                                        ...
                                        '\n*විසදුම:* _ඔබට මැකීමට අවශ්‍ය ප්ලගිනයට_ * __ * _ එකතු නොකර කරුණාකර උත්සාහ කරන්න. ඔබ තවමත් දෝෂයක් ලබා ගන්නේ නම්, like_ ""? (.*) / $ "" නමේ අවසානයට එකතු කිරීමට උත්සාහ කරන්න https://chat.whatsapp.com/GS7ZfzGCajz8Jylj2NqsZHttps://chat.whatsapp.com/GS7ZfzGCajz8Jylj2NqsZH._ '
                                        , MessageType.text
                                    );
                                }
                                    ...
                                    return await CdSew.sendMessage(CdSew.user.jid, '*🧟‍♂️ දෝෂ විශ්ලේෂණය [Sew Queen] 🧟‍♀️*' + 
                                        ...
                                        '\n*හේතුව:* _Commands that can be used by group admins occasionally dont see the split functi
                                        , MessageType.text
                                    );
                                }
